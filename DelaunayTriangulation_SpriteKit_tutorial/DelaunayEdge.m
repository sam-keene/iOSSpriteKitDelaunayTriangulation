...
- (NSString *) description {
   NSString *siteDesc = @"";
   NSString *vertexDesc = @"";
   siteDesc =   [NSString stringWithFormat: @"S: %lu-%lu", leftSite == nil ? -1 : leftSite.index, rightSite == nil ? -1 : rightSite.index];
   vertexDesc = [NSString stringWithFormat: @"V: %ld-%ld", leftVertex == nil ? -1 : leftVertex.index, rightVertex == nil ? -1 : rightVertex.index];
