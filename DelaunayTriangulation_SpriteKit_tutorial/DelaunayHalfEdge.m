...
- (NSString *) description {
   return [NSString stringWithFormat: @"HalfEdge (id: %p vertex: %ldddd edge: %lu - %lu orientation: %@ leftNeighbor: %p rightNeighbor: %p nextInPriorityQueue: %p ystar: %f", 
           self, vertex == nil ? -100 : vertex.index, (unsigned long)(edge.leftSite ? edge.leftSite.index : -1), (unsigned long)(edge.rightSite ? edge.rightSite.index : -1), orientation, edgeListLeftNeighbor, edgeListRightNeighbor, nextInPriorityQueue, ystar];
}
